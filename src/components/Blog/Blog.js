...
const Blog = () => {
    return (
        <div>
            ...
            <section className="m-1 m-md-4 bg-dark">
                <div className="shadow-lg p-0 pt-3 pb-3 p-md-5">
                    <h1 className="text-center mb-3 mb-md-5 text-white text-bg-success p-2">
                    What is react perfrom of react Router?
                    </h1>
                    <div className="row d-block d-md-flex justify-content-center align-items-center">
                        <div className="col-12 col-md-6">
                            <img className="img-fluid" src="https://reactrouter.com/twitterimage.jpg" alt=""/>
                        </div>
                        <div className="col-12 col-md-6 text-white">
                        <p className="card-text p-4">Routing is a process in which a user is directed to different pages based on their action or request. ReactJS Router is mainly used for developing Single Page Web Applications. React Router is used to define multiple routes in the application. When a user types a specific URL into the browser, and if this URL path matches any 'route' inside the router file, the user will be redirected to that particular route.
            ...
            <section className="m-1 m-md-4 bg-dark">
                <div className="shadow-lg p-0 pt-3 pb-3 p-md-5">
                    ...
                    <div className="row d-block d-md-flex justify-content-center align-items-center">
                        <div className="col-12 col-md-6">
                            <img className="img-fluid" src="https://miro.medium.com/max/1200/1*i84qwZI8_mxxM1zQ3hYd_A.jpeg" alt=""/>
                        </div>
                        <div className="col-12 col-md-6">
            ...
            <section className="m-1 m-md-4 bg-dark">
                <div className="shadow-lg p-0 pt-3 pb-3 p-md-5">
                    ...
                    <div className="row d-block d-md-flex justify-content-center align-items-center">
                        <div className="col-12 col-md-6">
                            <img className="img-fluid" src="https://miro.medium.com/max/1400/1*Yo1nkzOAMihE8Ia5O411PQ.jpeg" alt=""/>
                        </div>
